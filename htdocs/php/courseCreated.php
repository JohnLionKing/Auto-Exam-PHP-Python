...
//$conn = new mysqli("localhost","root","mysql", "rfgd_18896475_DB");
	...
	if (isset($_POST['submitButton1'])) {
		...
		$numberOfRecords = $row['CID'];
		
		$sql = "INSERT INTO Courses (CID, CCode, CName) 
				VALUES ($numberOfRecords + 1, '$CourseCode', '$CourseName')";

		if (mysqli_query($conn, $sql))
			echo '<h4 style="color:blue" align="center">Course was created successfully.</h4>';
		else {	
